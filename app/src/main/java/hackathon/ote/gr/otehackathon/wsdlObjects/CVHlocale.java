...
public class CVHlocale extends AttributeContainer implements KvmSerializable
{
    ...
    protected boolean loadProperty(PropertyInfo info,SoapObject soapObject,CVHExtendedSoapSerializationEnvelope __envelope)
    {
        ...
        if (info.name.equals("localeCode"))
        {
            if(obj!=null)
            {
                if (obj.getClass().equals(SoapPrimitive.class))
                {
                    ...
                    if(j.toString()!=null)
                    {
                        this.localeCode = j.toString();
                    }
                }
                else if (obj instanceof String){
                    this.localeCode = (String)obj;
                }
            }
            return true;
        }
